...
void CPG::walk(float* l_theta, float* r_theta)
{
    ...
    // r_theta[1] = r_theta_hip_p + r_hteta_hip_s;
    // r_theta[1] = r_theta_hip_p;
    // r_theta[2] = r_theta_knee_p;
    // r_theta[3] = r_theta_ankle_p + r_theta_ankle_s;
    ...
    // l_theta[1] = l_theta_hip_p + l_theta_hip_s;
    // l_theta[1] = l_theta_hip_p;
    // l_theta[2] = l_theta_knee_p;
    // l_theta[3] = l_theta_ankle_p + l_theta_ankle_s;
